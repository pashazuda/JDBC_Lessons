...
public class ConnectionManagerPool {
    ...
    private static void initConnectionPool() {
        ...
        for (int i = 0; i < size; i++) {
            var connection = open();
            var proxyConnection = (Connection) Proxy.newProxyInstance(ConnectionManagerPool.class.getClassLoader(), new Class[]{Connection.class},
    ...
    public static Connection get() {
        try {
            return pool.take(); // возвращает соединеие если оно есть
